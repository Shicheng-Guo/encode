...
write.table(rlt,file="drugtarget.dmg.smd.meta.table.pvalue.txt",sep="\t",quote=F,col.names = NA,row.names = T)
write.csv(rlt,file="drugtarget.dmg.smd.meta.table.pvalue.csv",quote=F)
